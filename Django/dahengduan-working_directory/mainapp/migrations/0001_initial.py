    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "IN_PARA_COMMENT",
                    models.CharField(max_length=1024, verbose_name="输入参数描述"),
                ),
                ("OUT_PARA", models.CharField(max_length=32, verbose_name="输出参数定义")),
                (
                    "OUT_PARA_COMMENT",
                    models.CharField(max_length=1024, verbose_name="输出参数描述"),
                ),
                ("VERSION", models.CharField(max_length=32, verbose_name="版本号")),
                (
                    "IS_DELETE",
                    models.CharField(default="N", max_length=1, verbose_name="是否删除"),
                ),
                (
                    "PRO_STATUS",
                    models.CharField(default="N", max_length=1, verbose_name="发布状态"),
                ),
            ],
        ),
    ]
