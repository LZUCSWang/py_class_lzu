  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var TIME_REG =
          /^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d\d)(?::(\d\d)(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/; // jshint ignore:line
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function getTooltipMarker(color, extraCssText) {
          return color
            ? '<span style="display:inline-block;margin-right:0.31em;' +
                "border-radius:0.625em;width:9px;height:9px;background-color:" +
                encodeHTML(color) +
                ";" +
                (extraCssText || "") +
                '"></span>'
      ...
      /***/ function (module, exports) {
        ...
        function detect(ua) {
          ...
          var ie =
            ua.match(/MSIE\s([\d.]+)/) || // IE 11 Trident/7.0; rv:11.0
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function renderPlainText(hostEl, ctx, text, style, rect) {
          ...
          if (!contentBlock || hostEl.__dirty) {
            contentBlock = hostEl.__textCotentBlock =
              textContain.parsePlainText(
                text,
                font,
                textPadding,
                style.truncate
        ...
        function setTokenTextStyle(
          ...
          if (!isBlock || !opt.disableBox) {
            ...
            textStyle.textBorderWidth =
              textStyleModel.getShallow("borderWidth");
            textStyle.textBorderRadius =
              textStyleModel.getShallow("borderRadius");
            textStyle.textBoxShadowColor =
              textStyleModel.getShallow("shadowColor");
            textStyle.textBoxShadowBlur =
              textStyleModel.getShallow("shadowBlur");
        ...
        echarts.extendChartView({
          ...
          render: function (seriesModel, ecModel, api) {
            ...
            seriesModel.layoutInstance.ondraw = function (
              ...
              var emphasisTextStyleModel =
                itemModel.getModel("textStyle.emphasis");
